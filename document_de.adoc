...
Eine Ausnahme bilden nur Datums- und Zeitangaben in Vermerken, die ausschließlich von Menschen lesbar sein müssen.
|===
...
[width="100%",cols="13%,9%,64%,14%",options="noheader",]
|===
