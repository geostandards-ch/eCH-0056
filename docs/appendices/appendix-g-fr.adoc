=== Format XML
.Définition du jeu de matrices de tuiles "Swiss2DTMS" au format XML
```xml
<?xml version="1.0" encoding="UTF-8"?>
<TileMatrixSet id="Swiss2DTMS" xmlns="http://www.opengis.net/tms/2.0" xmlns:tmsc="http://www.opengis.net/tms/2.0/common" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
...
```
=== Format JSON
.Définition du jeu de matrices de tuiles "Swiss2DTMS" au format JSON
```json
{
    "id":"Swiss2DTMS",
